...
@section('content')
    ...
    <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark artigo_doutrina_fundo">
        <div class="col-md-6 px-0">
            ...
            <p class="lead my-3 text-justify">Neste seção reuniremos informações sobre livros espíritas, seja para leitura online ou locais de venda. Aguarde...</p>
